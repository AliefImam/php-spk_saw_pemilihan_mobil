        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                if (isset($_POST['Submit'])) {
                    ...
                    $result = mysqli_query($connect, "INSERT INTO alternatifhp(id_mobil_bekas, Nama, kategori_kendaraan, Transmisi, Kisaran_harga_beli,
                            Kapasitas_Penumpang, Kapasitas_Bagasi, Tahun_Pembuatan, Warna_Mobil, Kondisi_Mesin, Bahan_Bakar, Ukuran_CC, Telepon) VALUES('','$nama','$ktg','$trs',
