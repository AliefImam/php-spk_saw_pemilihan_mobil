                    ...
                    if ($ukuran < 1044070000000000000) {
                        ...
                        if ($result) {
                            ...
                            echo "<script type=text/javascript>
                                ...
                                window.location.href='http://localhost/spksaw_mobil/alternatif.php';
                                </script>";
                        } else {
            ...
            <div class="col-md-6">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                        <form action="alternatif_uplad_foto.php?id_mobil_bekas=<?php echo $idm; ?>" method="post" name="form1" enctype="multipart/form-data">
