                    ...
                    <div class="panel-heading">
                        ...
                        if (($aksi <> "") and ($id <> "")) {
                            ...
                            echo "<script type=text/javascript>
                                window.location.href='http://localhost/spk_mobil_bekas/penjual_alternatif.php';
                                </script>";
                        }
                        ?>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="penjual_alternatif_edit.php?id_mobil_bekas=<?php echo $data['id_mobil_bekas']; ?>" title="Edit"><button type="button" class="btn btn-primary">Ubah</button></a>
                                            </td>
                                            <td>
                                                <a href="penjual_uplad_foto.php?id_mobil_bekas=<?php echo $data['id_mobil_bekas']; ?>" title="Edit"><button type="button" class="btn btn-primary">Uplad Foto</button></a>
                                            </td>
                                            <td>
                                                <a href="penjual_alternatif_foto.php?id_mobil_bekas=<?php echo $data['id_mobil_bekas']; ?>" title="Edit"><button type="button" class="btn btn-primary">Lihat Foto</button></a>
                                            </td>
                                            <td>
                                                <a href="penjual_alternatif_hapus.php?id_mobil_bekas=<?php echo $data['id_mobil_bekas']; ?> "><button type="button" class="btn btn-danger">Hapus</button></a>
                                            </td>
                                        </tr>
                                    <?php }
                                    ?>
